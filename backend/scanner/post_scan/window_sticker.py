    ...
    if vnorm:
        ...
        if "autoipacket" in html.lower() or "ipacket" in html.lower():
            ...
            if not any("sticker-puller/download" in u.lower() for u in out):
                from backend.scanner.dealer.sticker_provider import should_try_ipacket_website_plugin
...
def car_listing_may_have_sticker(car: dict[str, Any]) -> bool:
    ...
    from backend.scanner.dealer.sticker_provider import car_listing_sticker_fetch_eligible
