...
from backend.enrichment.knowledge_engine import decode_trim_logic, lookup_epa_aggregate
...
def tier_b_vdp(car: dict[str, Any]) -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    from backend.scanner.vdp_spec_extract import extract_specs_from_vdp_url
...
def tier_c_search(car: dict[str, Any], *, pause_s: float = 1.2) -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    from backend.enrichment.spec_search_client import (
