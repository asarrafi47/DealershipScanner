...
def lookup_epa_aggregate(year: int | None, make: str | None, model: str | None) -> dict[str, Any]:
    """
    Most common cylinders / drive / transmission for this year+make+model in epa_master.
    """
    out: dict[str, Any] = {"cylinders": None, "drivetrain": None, "gears": None, "transmission": None}
...
def merge_verified_specs(car: dict[str, Any]) -> dict[str, Any]:
    ...
    trans_ver = epa.get("transmission") or (
    ...
    return {
        ...
        "drivetrain_display": display_drive,
