...
echo ""
echo "==> Next:"
echo "    1. Optional: Dashboard -> scanner-* -> Config file path deploy/railway/railway.scanner-*.toml"
echo "       (Default railway.toml + RAILWAY_SERVICE_NAME routing also works.)"
...
echo "    4. Migrate inventory: bash deploy/railway/migrate-local-postgres-to-railway.sh"
